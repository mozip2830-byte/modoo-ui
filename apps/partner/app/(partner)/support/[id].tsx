...
export default function PartnerSupportDetailScreen() {
  ...
  const loadData = async (isRefresh = false) => {
    ...
    try {
      ...
      console.error("[partner][support] load detail error", err);
  ...
  return (
    <Screen scroll={false} style={styles.container}>
      <View style={styles.headerWrap}>
        <AppHeader title="문의 상세" subtitle="답변이 등록되면 여기에서 확인할 수 있어요." />
      </View>
            ...
            <Card style={styles.ticketCard}>
              ...
              <View style={styles.metaRow}>
                ...
                <Text style={styles.metaText}>
                  접수 {ticket.createdAt ? formatTimestamp(ticket.createdAt as never) : "-"}
                </Text>
              </View>
              <Text style={styles.metaText}>
                업데이트 {ticket.updatedAt ? formatTimestamp(ticket.updatedAt as never) : "-"}
              </Text>
            </Card>
          ) : null
        }
          ...
          <Card style={[styles.messageCard, item.senderType === "admin" && styles.adminCard]}>
            <View style={styles.messageHeader}>
              ...
              <Text style={styles.messageTime}>
                {item.createdAt ? formatTimestamp(item.createdAt as never) : ""}
              </Text>
            </View>
